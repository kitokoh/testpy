...
from dialogs import SettingsDialog, TemplateDialog # EditClientDialog is called from logic
...
class DocumentManager(QMainWindow):
    ...
    def setup_ui_main(self):
        ...
        form_group_box.setChecked(False)
    ...
    def create_actions_main(self):
        ...
        self.template_action = QAction(QIcon(":/icons/document.svg"), self.tr("Gérer les Modèles"), self); self.template_action.triggered.connect(self.open_template_manager_dialog)
