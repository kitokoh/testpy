...
# from main import get_notification_manager # For notifications - Already removed in previous step
...
class DocumentManager(QMainWindow):
    ...
    def notify(self, title, message, type='INFO', duration=5000, icon_path=None):
        ...
        """
        from main import get_notification_manager # For notifications - Ensuring import is here
