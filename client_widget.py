...
class ClientWidget(QWidget):
    ...
    def _setup_assignments_tab(self):
        try:
            ...
            logging.error(f"Error in _setup_assignments_tab: {e}", exc_info=True)
            QMessageBox.warning(self, self.tr("Erreur UI"), self.tr("Erreur initialisation onglet Affectations:\n{0}").format(str(e)))
