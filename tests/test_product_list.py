...
class TestProductList(unittest.TestCase):
    ...
    def _add_test_product(self, name_suffix, lang, price=10.0, desc="Test Desc"):
        ...
        self.assertIsNotNone(product_id, f"Failed to add product {unique_name}")
        ...
        return db_manager.get_product_by_id(product_id)
    ...
    def test_fetch_products(self):
        ...
        en_products = db_manager.get_products(language_code='en')
        ...
        fr_products = db_manager.get_products(language_code='fr')
    ...
    def test_update_product_price(self):
        ...
        update_success = db_manager.update_product_price(product['product_id'], new_price)
        self.assertTrue(update_success, "Failed to update product price")

        updated_product = db_manager.get_product_by_id(product['product_id'])
    ...
    def test_product_list_dialog_loads_data(self):
        ...
        all_db_products = db_manager.get_products(language_code=None)
        ...
        en_db_products = db_manager.get_products(language_code='en')
    ...
    @patch('product_list_dialog.QFileDialog.getSaveFileName')
    @patch('product_list_dialog.html_to_pdf_util.convert_html_to_pdf')
